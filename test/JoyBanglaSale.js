...
var JoyBanglaSale = artifacts.require('./JoyBanglaSale.sol');

contract('JoyBanglaSale', function (accounts) {
    var tokenInstance;
    ...
    it('initializes the contract with the correct values', function () {
        return JoyBanglaSale.deployed().then(function (instance) {
    ...
    it('ends token sale', function () {
        return JoyBangla.deployed().then(function (instance) {
            ...
            assert.equal(balance.toNumber(), 999990, 'returns all unsold joybangla tokens to admin');
